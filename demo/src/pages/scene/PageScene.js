...
let HBox = Boxs.HBox;
let Box = Boxs.Box;
var Icon2 = require('../../svg/apply.svg');
...
class Page extends React.Component {
    ...
    componentDidMount() {
        ...
        try {
            Ali.setTitle('顺风车', (result) => {result.error && alert(result.error)});
        } catch(e) {
            console.log('请使用手机打开');
        }
    }
    ...
    componentWillUnmount() {
        ...
        try {
            Ali.setTitle({text: 'tingle-ui'}, (result) => {result.error && alert(result.error)});
        } catch(e) {
            console.log('请使用手机打开');
        }
    }
    ...
    render() {
        ...
        return (
            <div className="page-secne">
                {
                    window.Ali.setTitle || 1
                        ? null
                        : <NavBar className={this.state.className} title={'顺风车'} rightText='刷新' isShow={this.state.isShow}
                ...
                <TabBar className="scene-tab-bar" activeIndex={this.state.activeIndex} onChange={this.handleTabBarClick.bind(this)}>
                            ...
                            <Tab onChange={t.handleChange.bind(t)}>
                                <Tab.Item title="乘客篇">
                                    <div className="scene-faq-list">
                                        <dl>
                                            <dt>1、新手怎样搭顺风车？</dt>
                                            <dd>猛击手机上的app图标，在更多中找到“顺风车”并轻点一下，“求搭车”会带给您美妙的回家之旅。</dd>
                                        </dl>
                                        <dl>
                    ...
                    <TabBar.Item title="法律声明" icon="scene-law">
                        <div className="scene-law">
                            <p>
                                为缓解同学们上下班的交通压力，倡导环保节能、绿色出行、文明交通的理念，顺风车平台开发小组特提供顺风车公益信息发布平台。提请同学们特别注意：机动车出行风险较高，各位同学务必注意安全，审慎选择出行方式，遵守交通规则、文明出行。</p>
                            <p>
